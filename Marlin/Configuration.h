...
#define STRING_CONFIG_H_AUTHOR "(Michael Malocha, 12-7-2020 SKR 1.4)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Extrude-O-Matic"
...
// A dual-nozzle that uses a servo motor to raise/lower one (or both) of the nozzles
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25.4, -50.6, 0}
...
/***
 * X_BED_SIZE and Y_BED_SIZE are usually 200, but I modified to accomodate the
 * custom software endstops through X_MIN_POS and Y_MAX_POS
 */
